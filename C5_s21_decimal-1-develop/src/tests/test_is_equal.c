...
START_TEST(test_s21_is_equal_true) {
    s21_decimal a, b;
...
START_TEST(test_s21_is_equal_false) {
    s21_decimal a, b;
...
Suite *test_is_equal(void) {
    ...
    tcase_add_test(tc_core, test_s21_is_equal_false);
    tcase_add_test(tc_core, test_s21_is_equal_true);
