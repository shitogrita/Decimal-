...
Suite *test_is_less_or_equal(void) {
    ...
    tcase_add_test(tc_core, test_s21_is_less_or_equal_true);
    tcase_add_test(tc_core, test_s21_is_less_or_equal_equal);
    tcase_add_test(tc_core, test_s21_is_less_or_equal_false);
